...
public class Disease3_Recover extends AppCompatActivity {
   ...
   private String userId,division,district,upazila,date="",DiseaseName="",name="",email="",Year="",Month="",key="";
   ...
   private FirebaseUser user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_disease3__recover);
        ...
        male1=findViewById(R.id.disease3recovermale1);
        male2=findViewById(R.id.disease3recovermale2);
        male3=findViewById(R.id.disease3recovermale3);
        female1=findViewById(R.id.disease3recoverfemale1);
        female2=findViewById(R.id.disease3recoverfemale2);
        female3=findViewById(R.id.disease3recoverfemale3);
        button=findViewById(R.id.disease3recoverdate);
        submit=findViewById(R.id.disease3recoversubmitid);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog=new DatePickerDialog(Disease3_Recover.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth,mDateSetListenar,year,month,day);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Disease3_Recover.this.startActivity(new Intent(Disease3_Recover.this, Disease3_Reporting.class));
