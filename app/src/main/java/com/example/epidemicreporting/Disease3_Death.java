...
public class Disease3_Death extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_disease3__death);
        ...
        male1 = findViewById(R.id.disease3maledeathid1);
        male2 = findViewById(R.id.disease3maledeathid2);
        male3 = findViewById(R.id.disease3maledeathid3);
        female1 = findViewById(R.id.disease3deathfemale1);
        female2 = findViewById(R.id.disease3deathfemale2);
        female3 = findViewById(R.id.disease3deathfemale3);
        button = findViewById(R.id.disease3deathdateid);
        submit = findViewById(R.id.disease3deathmalesubmitid);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(Disease3_Death.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth, mDateSetListenar, year, month, day);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Disease3_Death.this.startActivity(new Intent(Disease3_Death.this, Disease3_Reporting.class));
