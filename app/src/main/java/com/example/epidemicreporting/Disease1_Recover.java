...
public class Disease1_Recover extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_disease1__recover);
        ...
        male1=findViewById(R.id.disease1recovermale1);
        male2=findViewById(R.id.disease1recovermale2);
        male3=findViewById(R.id.disease1recovermale3);
        female1=findViewById(R.id.disease1recoverfemale1);
        female2=findViewById(R.id.disease1recoverfemale2);
        female3=findViewById(R.id.disease1recoverfemale3);
        button=findViewById(R.id.disease1recoverdate);
        submit=findViewById(R.id.disease1recoversubmitid);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog=new DatePickerDialog(Disease1_Recover.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth,mDateSetListenar,year,month,day);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Disease1_Recover.this.startActivity(new Intent(Disease1_Recover.this, Disease1_Reporting.class));
