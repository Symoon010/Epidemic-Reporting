...
public class Disease2_Death extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_disease2__death);
        ...
        male1 = findViewById(R.id.disease2maledeathid1);
        male2 = findViewById(R.id.disease2maledeathid2);
        male3 = findViewById(R.id.disease2maledeathid3);
        female1 = findViewById(R.id.disease2deathfemale1);
        female2 = findViewById(R.id.disease2deathfemale2);
        female3 = findViewById(R.id.disease2deathfemale3);
        button = findViewById(R.id.disease2deathdateid);
        submit = findViewById(R.id.disease2deathmalesubmitid);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(Disease2_Death.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth, mDateSetListenar, year, month, day);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Disease2_Death.this.startActivity(new Intent(Disease2_Death.this, Disease2_Reporting.class));
