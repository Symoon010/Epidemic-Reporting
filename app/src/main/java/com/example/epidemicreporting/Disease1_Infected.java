...
public class Disease1_Infected extends AppCompatActivity {
    ...
    String userId,division="",district="",upazila="",date="",Year="",name="",email="",Month="",key="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_disease1__infected);
        ...
        male1=findViewById(R.id.disease1maleinfectedid1);
        male2=findViewById(R.id.disease1maleinfectedid2);
        male3=findViewById(R.id.disease1maleinfectedid3);
        female1=findViewById(R.id.disease1infectedfemale1);
        female2=findViewById(R.id.disease1infectedfemale2);
        female3=findViewById(R.id.disease1infectedfemale3);
        button=findViewById(R.id.disease1infecteddateid);
        submit=findViewById(R.id.disease1infectedmalesubmitid);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog=new DatePickerDialog(Disease1_Infected.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth,mDateSetListenar,year,month,day);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              //save table
                ...
                Disease1_Infected.this.startActivity(new Intent(Disease1_Infected.this, Disease1_Reporting.class));
