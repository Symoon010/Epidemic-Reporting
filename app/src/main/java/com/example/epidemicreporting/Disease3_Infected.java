...
public class Disease3_Infected extends AppCompatActivity {
    ...
    String userId,division,district,upazila,date="",name="",email="",Year="",Month="",key="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_disease3__infected);
        ...
        male1=findViewById(R.id.disease3maleinfectedid1);
        male2=findViewById(R.id.disease3maleinfectedid2);
        male3=findViewById(R.id.disease3maleinfectedid3);
        female1=findViewById(R.id.disease3infectedfemale1);
        female2=findViewById(R.id.disease3infectedfemale2);
        female3=findViewById(R.id.disease3infectedfemale3);
        button=findViewById(R.id.disease3infecteddateid);
        submit=findViewById(R.id.disease3infectedmalesubmitid);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog=new DatePickerDialog(Disease3_Infected.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth,mDateSetListenar,year,month,day);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                DiseaseName=snapshot.child("3").getValue().toString();
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Disease3_Infected.this.startActivity(new Intent(Disease3_Infected.this, Disease3_Reporting.class));
