...
public class Disease2_Recover extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_disease2__recover);
        ...
        male1=findViewById(R.id.disease2recovermale1);
        male2=findViewById(R.id.disease2recovermale2);
        male3=findViewById(R.id.disease2recovermale3);
        female1=findViewById(R.id.disease2recoverfemale1);
        female2=findViewById(R.id.disease2recoverfemale2);
        female3=findViewById(R.id.disease2recoverfemale3);
        button=findViewById(R.id.disease2recoverdate);
        submit=findViewById(R.id.disease2recoversubmitid);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog=new DatePickerDialog(Disease2_Recover.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth,mDateSetListenar,year,month,day);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Disease2_Recover.this.startActivity(new Intent(Disease2_Recover.this, Disease2_Reporting.class));
