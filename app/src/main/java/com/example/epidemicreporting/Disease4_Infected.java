...
public class Disease4_Infected extends AppCompatActivity {
    ...
    String userId,division,district,upazila,date="",email="",name="",Year="",Month="",key="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_disease4__infected);
        ...
        male1=findViewById(R.id.disease4maleinfectedid1);
        male2=findViewById(R.id.disease4maleinfectedid2);
        male3=findViewById(R.id.disease4maleinfectedid3);
        female1=findViewById(R.id.disease4infectedfemale1);
        female2=findViewById(R.id.disease4infectedfemale2);
        female3=findViewById(R.id.disease4infectedfemale3);
        button=findViewById(R.id.disease4infecteddateid);
        submit=findViewById(R.id.disease4infectedmalesubmitid);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog=new DatePickerDialog(Disease4_Infected.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth,mDateSetListenar,year,month,day);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Disease4_Infected.this.startActivity(new Intent(Disease4_Infected.this, Disease4_Reporting.class));
