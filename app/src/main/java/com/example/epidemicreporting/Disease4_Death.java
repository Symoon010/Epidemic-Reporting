...
public class Disease4_Death extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_disease4__death);
        ...
        male1 = findViewById(R.id.disease4maledeathid1);
        male2 = findViewById(R.id.disease4maledeathid2);
        male3 = findViewById(R.id.disease4maledeathid3);
        female1 = findViewById(R.id.disease4deathfemale1);
        female2 = findViewById(R.id.disease4deathfemale2);
        female3 = findViewById(R.id.disease4deathfemale3);
        button = findViewById(R.id.disease4deathdateid);
        submit = findViewById(R.id.disease4deathmalesubmitid);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(Disease4_Death.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth, mDateSetListenar, year, month, day);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Disease4_Death.this.startActivity(new Intent(Disease4_Death.this, Disease4_Reporting.class));
